...
World.prototype.generateFood = function() {
  this.food.x = Math.round(Math.round(Math.random() * 380)/20) * 20;
  this.food.y = Math.round(Math.round(Math.random() * 280)/20) * 20;
...
World.prototype.growSnake = function() {
  ...
  this.totalSnake.unshift(new Snake (snakeXValue, snakeYValue, 20, 20));
